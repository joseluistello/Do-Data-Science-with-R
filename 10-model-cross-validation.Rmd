...
```{r modelfit, fig.cap ="Model's Fitting, Overfitting and Underfitting", out.width = "100%", fig.align ="center", echo =FALSE}
...
```{r model2CV, out.width='50%', fig.show='hold', fig.align='center', fig.cap='Decision Tree CV model2.'}
...
```{r treemodel3CV, out.width='50%', fig.show='hold', fig.cap='Decision Tree CV model3.', fig.align='center'}
#Visualize cross validation tree
