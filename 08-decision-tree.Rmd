...
```{r tree1, out.width='50%', fig.show='hold', fig.cap ="The decision tree only has *Sex* test condition.", echo = FALSE, warning=FALSE, message=FALSE, fig.align ="center"}
...
```{r diff_1_2, fig.cap="The differnces between two predictions"}
