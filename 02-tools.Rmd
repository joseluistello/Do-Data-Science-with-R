...
```{r rgui, fig.cap='Screen capture of RGui: where Console i son the left and Editor is on the right', out.width='95%', fig.asp=.75, fig.align='center', echo=FALSE}
knitr::include_graphics("Capture/RGui.jpg")
```
...
knitr::include_graphics("Capture/RStudio.png")
...
knitr::include_graphics("Capture/R.png")
...
knitr::include_graphics("Capture/Rinstall.png")
...
knitr::include_graphics("Capture/Rinstlang.png")
...
knitr::include_graphics("Capture/Rstudio1.png")
```
...
knitr::include_graphics(here::here("Capture", "Rstudio.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "environment.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "history.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "toconsole.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "tosource.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "plot.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "help.jpg"))
```
...
knitr::include_graphics(here::here("Capture", "RSview.png"))
```
...
knitr::include_graphics(here::here("Capture", "RSPaneview.png"))
```
...
knitr::include_graphics(here::here("Capture", "RSsc.png"))
```
...
knitr::include_graphics(here::here("Capture", "setwk.png"))
```
...
knitr::include_graphics(here::here("Capture", "setwkc.png"))
```
...
knitr::include_graphics(here::here("Capture", "RStudionew.png"))
```
...
knitr::include_graphics(here::here("Capture", "RStudionewfile.png"))
```
...
knitr::include_graphics(here::here("Capture", "new.png"))
```
