...
```{r  Fare, fig.align = 'center', fig.show="hold", out.width = "50%", fig.cap = "Plot of *Fare* distribution and survival rate."}
...
#plot the 3-way relationship of sex, pclass, and survival
ggplot(data[1:891,], aes(x = Sex, fill = Survived)) +
  geom_bar() +
  facet_wrap(~Pclass) + 
  ggtitle("Pclass") +
