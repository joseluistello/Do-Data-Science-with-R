...
knitr::include_graphics(here::here("Capture", "NewProject.png"))
```
...
knitr::include_graphics("Capture/Rhelp.png")
...
knitr::include_graphics("Capture/importdata.png")
...
```{r Rstr, fig.cap='Screen capture of str(train) and str(test)', out.width='130%', fig.asp=.75, fig.align='center', echo=FALSE }

knitr::include_graphics("Capture/RstrResult.png")
...
knitr::include_graphics("Capture/DatafrKaggle.png")
...
```{r Survivalrate, fig.cap = "Total count and survive rate of passenger on Pcalss.", fig.align = 'center', warning=FALSE}
...
```{r age, warning=FALSE, fig.align = 'center', fig.show="hold", out.width = "50%", fig.cap = "*Age* ditribution and its survive rate."}
...
```{r  tecketnumber, fig.align = 'center', out.width = "90%", fig.cap = "Plot of *Ticket* value distribution."}
#plot ticket values 
ggplot(data[1:891,], aes(x = Ticket)) +
  ...
  ylab("Total Count")
```
```{r  tecketratio, fig.align = 'center', fout.width = "90%", fig.cap = "Plot of *Ticket* survival rate."}
