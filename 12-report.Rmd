...
```
```{r title_image, fig.align = 'center', out.width = "80%", echo=FALSE}

knitr::include_graphics(here::here("images", "analytical-report.png"))
```
...
```{r rfmodel2results, warning=FALSE,  message=FALSE, fig.cap = "The detials of RF_model2", fig.align='center', out.width = "80%"}
...
knitr::include_graphics(here::here("Capture", "RF_model2.png"))
#RF_model2
```
...
```{r top10, fig.cap = "The Top 10 trees and the summary of OOB of RF_model2"}
...
```{r RF_model2_cv, fig.cap = "The details of RF_model2_CV"}
...
```{r visualmodelPrediction, fig.align='center', warning=FALSE, cache=TRUE, fig.cap="2D Visualization of Model RE_model2's Prediciton"}
...
```{r RFmodel2impPlot, warning=FALSE, message=FALSE, fig.cap = "The ordered importance of the predictors", fig.align='center'}
...
```{r simplottreemodel3, fig.cap = "The simple decision tree of RF_model2", warning=FALSE, message = FALSE, fig.align='center'}
library(rpart.plot)
load("./data/model3.rda")
...
```{r Title}
#let us further re-Engineer title 
table(RE_data$Title)
```
...
```{r fig.cap = "The values of Title in RF_model2 and in raw data"}
# Parse out title
...
```{r newtitlewithsuv, fig.align='center', fig.cap="Surival Rates for new.Title"}
# Make title a factor
data$new.Title <- as.factor(data$Title)
...
```{r  newcattitlewithsuv, fig.cap="Surival Rates for re-categorised new.Title", fig.align='center'}
# Visualize 
ggplot(data[1:891,], aes(x = new.Title, fill = as.factor(Survived))) +
  geom_bar()
```
